...
public class SQLProduccionDAO implements ProduccionDAO {
    ...
    @Override
    public void save(Produccion produccion) throws DatabaseErrorException, NotFoundException {
        ...
        try (
            ...
            preparedStatement.setString( 7, produccion.getActores() );
